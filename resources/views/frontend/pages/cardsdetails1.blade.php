            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="rounded-2xl overflow-hidden glass-card h-64 md:h-96 relative group animate-fade-up"
                        ...
                        <img src="{{ asset('imagess/projects/janamaitri.png') }}" alt="Server Infrastructure"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute bottom-6 left-6 z-20">
                            <span
                                class="px-3 py-1 rounded-full text-xs text-slate-200 font-bold uppercase tracking-wider blue-gradient shadow-lg">Enterprise Deployment</span>
                        </div>
                    </div>
                    ...
                    <section class="shadow-lg bg-white/20 p-6 md:p-8 rounded-2xl animate-fade-up"
                        ...
                        <p class="text-stone-800 leading-relaxed text-lg">
                            ...
                            and advanced security protocols. This project focuses on creating a resilient environment
                            capable of handling high traffic while maintaining strict data integrity.
                        </p>
                    </section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-up" style="animation-delay: 0.3s">
                        ...
                        <div class="bg-white/20 shadow-lg p-6 rounded-2xl">
                            ...
                            <p class="text-slate-600 text-sm leading-relaxed">
                                Implemented enterprise-grade networking with redundant firewalls, intrusion detection
                                systems, and secure VPN access for remote administration. The stack ensures zero single
                                points of failure across the network topology.
                            </p>
                        </div>
                    </div>
                    ...
                    <section
                        ...
                        <p class="text-stone-800 text-lg mb-4">
                            "Tech Verse delivered a robust and secure infrastructure that exceeded our expectations. Their
                            attention to detail and commitment to security was impressive."
                        </p>
                        <cite class="text-sm font-semibold text-[#3b82f6] not-italic">— Managing Director, Client
                            Office</cite>
                    </section>
                </div>
                ...
                <aside class="space-y-6">
                    <div class="bg-white/20 shadow-lg p-6 rounded-2xl sticky top-8 animate-fade-up"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center text-green-500">
