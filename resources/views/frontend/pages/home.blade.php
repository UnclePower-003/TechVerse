            ...
            @if ($heroHeader)
                <div class="flex flex-col lg:items-start items-center justify-center text-center lg:text-left">
                    ...
                    <h1
                        ...
                        <span class='md:text-white lg:text-black max-sm:text-black'> {{ $heroHeader->title_small_1 }}
                        </span> {{ $heroHeader->title_main }}<br>
                        <span class='md:text-white lg:text-black sm:text-black'>{{ $heroHeader->title_small_2 }}</span>
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] to-[#0ea5e9]">{{ $heroHeader->title_highlight }}</span>
                    </h1>
                    ...
                    <div
                        ...
                        <a href="{{ $heroHeader->primary_btn_link }}"
                            class="px-8 py-2 text-lg font-bold text-[#d1e2f6] bg-[#2563eb] rounded-lg hover:bg-[#3b82f6] transition shadow-lg shadow-[#2563eb]/40 text-center">
                            {{ $heroHeader->primary_btn_text }}
                        </a>
                        <a href="{{ $heroHeader->secondary_btn_link }}"
                            class="px-8 py-2 text-lg font-bold text-stone-600 border max-lg:bg-white lg:border-gray-500 rounded-lg hover:border-transparent lg:hover:bg-[#d1e2f6] hover:text-[#0f172a] transition text-center">
                            {{ $heroHeader->secondary_btn_text }}
                        </a>
                    </div>
                </div>
            @endif
