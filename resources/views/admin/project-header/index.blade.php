    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                <i class="fas fa-project-diagram mr-2 text-primary"></i> Project Headers
            </h1>
            <p class="text-sm text-gray-500 mt-1">Manage the hero sections and titles for your projects page.</p>
        </div>

        {{-- Add Button --}}
        {{-- <a href="{{ route('project-header.create') }}"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <thead class="bg-primary text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Main Title</th>
                        <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Description</th>
                        <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest w-32 text-center">Status</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-bold text-gray-900">
                                    {{ Str::limit($header->main_title, 40) }}
                                </div>
                                @if($header->small_title)
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <div class="flex justify-center items-center space-x-2">
                                    {{-- Edit --}}
                                    <a href="{{ route('project-header.edit', $header) }}"
                                    ...
                                    {{-- Delete --}}
                                    {{-- <form action="{{ route('project-header.destroy', $header) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 font-medium">No project headers found.</p>
                                    <a href="{{ route('project-header.create') }}"
