        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-heading mr-2 text-primary"></i> Hero Headers
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the text overlays, badges, and primary titles for the hero
                    section.</p>
            </div>

            {{-- <a href="{{ route('hero-header.create') }}"
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($headers as $header)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                {{-- Main Title --}}
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900">{{ Str::limit($header->title_main, 50) }}
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('hero-header.edit', $header) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form action="{{ route('hero-header.destroy', $header) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        <i class="fas fa-heading text-5xl text-gray-200 mb-4"></i>
                                        <p class="text-gray-500 font-medium">No hero headers found.</p>
                                        <a href="{{ route('hero-header.create') }}"
