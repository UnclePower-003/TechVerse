        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-award mr-2 text-primary"></i> Project Quality Cards
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the quality features and value propositions displayed on the
                    project pages.</p>
            </div>

            {{-- Add Button --}}
            <a href="{{ route('project-quality.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-widest">Delay (ms)</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center items-center space-x-3">
                                        <a href="{{ route('project-quality.edit', $quality) }}"
                                            class="p-2 text-primary hover:bg-blue-50 rounded-lg transition-all"
                                            title="Edit Quality">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        <form action="{{ route('project-quality.destroy', $quality) }}" method="POST"
                                            onsubmit="return confirm('Delete this quality card?');" class="inline-block">
                                            @csrf @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No quality cards found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
