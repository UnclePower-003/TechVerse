        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-car mr-2 text-primary"></i> About Drive
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the drive features and informational points.</p>
            </div>

            {{-- Add Button - Uncomment and use route if needed --}}
            {{-- <a href="{{ route('about-drive.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-widest">Points Count</th>
                        ...
                        @forelse ($drives as $drive)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <span class="px-2 py-1 bg-gray-100 text-gray-700 text-xs font-semibold rounded border border-gray-200">
                                        {{ count($drive->points ?? []) }} Points
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="{{ route('about-drive.edit', $drive) }}"
                                        ...
                                        {{-- <form action="{{ route('about-drive.destroy', $drive) }}" method="POST" ...> --}}
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        <i class="fas fa-car text-5xl text-gray-200 mb-4"></i>
                                        <p class="text-gray-500 font-medium">No drive records found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
