    ...
    <div class="p-6 max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Manage physical addresses, phone numbers, and email details displayed
                    on the site.</p>
            </div>
                                    ...
                                    <div class="space-y-3">
                                        @foreach ($info->items as $item)
                                            <div class="flex items-start space-x-3">
                                                <div
                                                    class="flex-shrink-0 w-8 h-8 bg-blue-50 text-primary rounded-lg flex items-center justify-center">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        <i class="fas fa-address-card text-5xl text-gray-200 mb-4"></i>
                                        <p class="text-gray-500 font-medium">No contact info found.</p>
                                        <a href="{{ route('contact-info.create') }}"
