        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-layer-group mr-2 text-primary"></i> Products Header
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the titles, highlights, and display status for the products section header.</p>
            </div>

            {{-- <a href="{{ route('products-header.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Highlight</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('products-header.edit', $header) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form action="{{ route('products-header.destroy', $header) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No products headers found.</p>
                                        <a href="{{ route('products-header.create') }}"
