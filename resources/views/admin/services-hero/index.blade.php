        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-layer-group mr-2 text-primary"></i> Services Hero Sliders
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the hero banners specific to the services page across all
                    devices.</p>
            </div>

            {{-- <a href="{{ route('services-hero.create') }}"
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('services-hero.edit', $hero) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form action="{{ route('services-hero.destroy', $hero) }}" method="POST"
                                            onsubmit="return confirm('Are you sure you want to delete this hero slider?');"
                                            class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No service hero sliders found.</p>
                                        <a href="{{ route('services-hero.create') }}"
