        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa- proyect-diagram mr-2 text-primary"></i> Project Heroes
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the hero banners and featured content for your projects.</p>
            </div>

            {{-- <a href="{{ route('project-hero.create') }}"
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <img src="{{ asset('storage/' . $hero->image) }}"
                                        class="h-14 w-24 object-cover rounded-lg border border-gray-100 shadow-sm"
                                        alt="{{ $hero->title }}">
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('project-hero.edit', $hero) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form action="{{ route('project-hero.destroy', $hero) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No project heroes found.</p>
                                        <a href="{{ route('project-hero.create') }}"
