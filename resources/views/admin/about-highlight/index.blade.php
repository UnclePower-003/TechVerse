        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-star mr-2 text-primary"></i> About Highlights
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the key features and highlights displayed in the About section.</p>
            </div>

            <a href="{{ route('about-highlight.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Title & Description</th>
                        ...
                        @forelse($highlights as $highlight)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center justify-center w-10 h-10 bg-blue-50 text-primary rounded-lg border border-blue-100">
                                ...
                                {{-- Title & Description --}}
                                <td class="px-6 py-4">
                                    <div class="text-sm font-bold text-gray-900">{{ $highlight->title }}</div>
                                    <div class="text-xs text-gray-500 mt-0.5 line-clamp-1">{{ Str::limit($highlight->description, 70) }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('about-highlight.edit', $highlight) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form action="{{ route('about-highlight.destroy', $highlight) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No highlights found.</p>
                                        <a href="{{ route('about-highlight.create') }}"
