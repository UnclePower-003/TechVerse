        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa- layer-group mr-2 text-primary"></i> Products Hero Sliders
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the hero banners for the products section across all device types.</p>
            </div>

            {{-- <a href="{{ route('products-hero.create') }}"
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="{{ route('products-hero.edit', $hero) }}"
                                            class="p-2 text-[#266eb1] hover:bg-blue-400 hover:text-white rounded-lg transition-all"
                                            title="Edit Hero">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        {{-- <form action="{{ route('products-hero.destroy', $hero) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No product hero banners found.</p>
                                        <a href="{{ route('products-hero.create') }}"
